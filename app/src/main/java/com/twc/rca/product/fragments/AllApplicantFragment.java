...
public class AllApplicantFragment extends BaseFragment {
    ...
    public static AllApplicantFragment getInstance() {
        AllApplicantFragment mnaFragment = new AllApplicantFragment();
        return mnaFragment;
    }
            ...
            try {
                ...
                if (data.length() > 0) {
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        //if(applicantModel.applicantSubmited.equalsIgnoreCase("Y"))
